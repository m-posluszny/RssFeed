...
class RSSHandler:
    ...
    def parse_xml(self):
        ...
        for item in rssItems:
            ...
            itemPubParsed = item["published_parsed"] if "published_parsed" in item else time.localtime(0)
            
            self.__articles.append(Article(itemTitle, itemLink, itemSumm, itemPub, itemPubParsed))
